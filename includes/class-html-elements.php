...
/**
 * MOSS_HTML_Elements Class
 *
 * @since 1.0
 */
class MOSS_SAF_HTML_Elements {
	...
	public function select( $args = array() ) {
		$defaults = array(
			...
			'chosen'           => false,
			'multiple'         => false,
			'show_option_all'  => _x( 'All', 'all dropdown items', 'vat_moss_saf' ),
			'show_option_none' => _x( 'None', 'no dropdown items', 'vat_moss_saf' )
		);
	...
	public function ajax_user_search( $args = array() ) {
		...
		$defaults = array(
			'name'        => 'user_id',
			'value'       => null,
			'placeholder' => __( 'Enter username', 'vat_moss_saf' ),
			'label'       => null,
			'desc'        => null,
            'class'       => '',
			'disabled'    => false,
		...
		$output  = '<span class="ecel_user_search_wrap">';
			...
			$output .= '<span class="moss_saf_user_search_results"></span>';
		$output .= '</span>';
